...
public class Jamie {
	...
	public static void main(String[] args) {
		while (qq) {
			...
			while (!a.equalsIgnoreCase("no") && !a.equalsIgnoreCase("yes") && !a.equalsIgnoreCase("of course")
			...
			if (a.equalsIgnoreCase("yes") || a.equalsIgnoreCase("sure") || a.equalsIgnoreCase("obviously")
				...
				while (!whatIsIt.equalsIgnoreCase("math problem") && !whatIsIt.equalsIgnoreCase("do a math problem")
						...
						&& !whatIsIt.equalsIgnoreCase("when was I born?") && !whatIsIt.equalsIgnoreCase("game")
						&& !whatIsIt.equalsIgnoreCase("game!") && !whatIsIt.equalsIgnoreCase("play a game!")
						&& !whatIsIt.equalsIgnoreCase("be annoying")) {
					int random = new Random().nextInt(3);
					if (random == 0) {
						joptionpane = "Please say your answer so that I can comprehend.";
						speak("Please say your answer so that I can comprehend");
				...
				if (whatIsIt.equalsIgnoreCase("play a game") || whatIsIt.equalsIgnoreCase("game")
						|| whatIsIt.equalsIgnoreCase("game!") || whatIsIt.equalsIgnoreCase("play a game!")) {
